...
//
// 지하 500m 라 하늘도 태양도 없다. **보이는 모든 밝기는 우리가 놓은 것**이고,
// 그래서 "어디를 밝힐지" 가 곧 "어디를 보게 할지" 다 (facility.md 3장).
//
// ── 짝으로 둔다 ────────────────────────────────────────────────────────────
...
const LIT = {
  plaza: { pitch: 3.6, lit: 6.0, lamp: 'lamp', power: 60, range: 22, warm: 0xdfe8ff },
...
//
// **세게 주면 안 된다.** 지하 시설의 인상은 "빛이 닿는 곳과 안 닿는 곳" 의
// 차이에서 나온다.
